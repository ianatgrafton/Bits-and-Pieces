...
Set-WmiNamespaceSecurity -namespace root\cimv2 -operation add -account "Distributed COM Users" -permissions Enable,RemoteAccess,MethodExecute
Set-WmiNamespaceSecurity -namespace root\cimv2 -operation add -account "Performance Monitor Users" -permissions Enable,RemoteAccess,MethodExecute
